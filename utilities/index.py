...
def index_file(file, index_name, host="localhost", max_docs=2000000):
    docs_indexed = 0
...
def main(source_dir: str, index_name: str, workers: int, host: str, max_docs: int):
    logger.info(f"Indexing {source_dir} to {index_name} with {workers} workers to host {host} with a maximum number of docs sent per worker of {max_docs}.")
