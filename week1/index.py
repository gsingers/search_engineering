...
@click.option(
    "--file_glob",
    "-g",
    help="The file glob to use to get the files to index in the source dir.",
    default="*.xml",
)
@click.option(
    "--index_name", "-i", default="bbuy_products", help="The name of the index to write to"
)
...
@click.option(
    ...
    "-m",
    default=200000,
    help="The maximum number of docs to be indexed PER WORKER PER FILE.",
)
@click.option(
    "--batch_size", "-b", default=200, help="The number of docs to send per request. Max of 5000"
)
@click.option(
    "--refresh_interval",
    "-r",
    default="5s",
    help="The number of docs to send per request. Max of 5000",
)
def main(
    source_dir: str,
    file_glob: str,
    ...
    with concurrent.futures.ProcessPoolExecutor(max_workers=workers) as executor:
        futures = [
            executor.submit(index_file, file, index_name, host, max_docs, batch_size)
            for file in files
        ]
