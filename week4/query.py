...
def query_opensearch(worker_num, query_file: str, host: str, port: str, index_name: str, max_queries: int, seed: int, stop_event):
    ...
    logger.info(f"WN: {worker_num}: Connecting to OpenSearch at {host}:{port}")
...
@click.option('--port', '-p', default="9200", help="The port at which OpenSearch is running")
...
def main(query_file: str, index_name: str, host: str, port: str, max_queries: int, seed: int, workers: int):
